...
function countUniqueWords(str) {
    // Removing punctuation marks and splitting the string into words
...
const inputString = "Hi, My name is Awdiz, I am located at Vashi.";
const uniqueWordCounts = countUniqueWords(inputString);
